...
def show():
    ...
    with tab2:
        ...
        **Data Quality Finding (documented in Notebook 09):**
        ...
        c1.metric("XGBoost CV-RMSE", "5.60", delta="vs baseline 5.88")
        c2.metric("LightGBM CV-RMSE", "5.67", delta="vs baseline 5.88")
        c3.metric("Best Model", "XGBoost", delta="lower RMSE wins")
